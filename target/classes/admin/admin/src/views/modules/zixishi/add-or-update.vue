          ...
          <el-form-item class="input" label="位置" prop="weizhi">
              <el-input v-model="ruleForm.weizhi" 
                placeholder="位置" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="配套设施" prop="peitaosheshi">
          <el-input v-model="ruleForm.peitaosheshi" 
              placeholder="配套设施" clearable  :readonly="ro.peitaosheshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="配套设施" prop="peitaosheshi">
              <el-input v-model="ruleForm.peitaosheshi" 
                placeholder="配套设施" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" label="座位总数" prop="number">
              <el-input v-model="ruleForm.number" 
                placeholder="座位总数" readonly></el-input>
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="教室详情" prop="jiaoshixiangqing">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiaoshixiangqing" label="教室详情" prop="jiaoshixiangqing">
                    <span>{{ruleForm.jiaoshixiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
